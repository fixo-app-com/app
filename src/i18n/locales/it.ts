const it = {
  ...
  home: {
    title: "Home",
    yearlyIncome: "Entrate annuali",
    monthlyIncome: "Entrate mensili",
    totalCosts: "Costi totali",
    available: "Disponibile",
    setYearlyIncome: "Imposta entrate annuali",
    setMonthlyIncome: "Imposta entrate mensili",
    pctUsed: "{{pct}}% delle entrate utilizzato",
    enterIncome: "Inserisci le tue entrate {{period}} totali",
    ...
    ofIncomeFixed: "delle tue entrate va in spese fisse",
    idealUnder: "Ideale: sotto il 50%",
    dailyBudget: "Budget giornaliero",
    perDay: "/giorno",
    fromAvailable: "da {{amount}} disponibili",

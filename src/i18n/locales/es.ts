const es = {
  ...
  home: {
    ...
    setYearlyIncome: "Establecer ingreso anual",
    setMonthlyIncome: "Establecer ingreso mensual",
    pctUsed: "{{pct}}% del ingreso usado",
    enterIncome: "Ingresa tu ingreso {{period}} total",
